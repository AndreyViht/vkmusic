...
namespace VK_UI3.Helpers
{
    internal static class ErrorReportHelper
    {
        ...
        public static string BuildFullReport(Exception exception, string source = "Unknown")
        {
            ...
            sb.AppendLine("========================================");
            sb.AppendLine("  КРИТИЧЕСКАЯ ОШИБКА ПРИЛОЖЕНИЯ Viht Music VK");
            sb.AppendLine("========================================");
            sb.AppendLine();
        ...
        public static void ShowErrorDialog(string report)
        {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        try
                        {
                            MessageBoxW(IntPtr.Zero,
                                ...
                                "Viht Music VK — Критическая ошибка",
            ...
            catch
            {
                ...
                MessageBoxW(IntPtr.Zero, report, "Viht Music VK — Критическая ошибка", 0x00000010 | 0x00001000);
            }
        }
        ...
        private static void ShowNativeErrorDialog(string report)
        {
            ...
            var hwnd = CreateWindowExW(
                0, atom, "Viht Music VK — Критическая ошибка",
